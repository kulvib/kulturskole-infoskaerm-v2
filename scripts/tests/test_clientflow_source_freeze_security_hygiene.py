...
def test_1325_1226_frozen_source_leads_promoted_catalog_by_one() -> None:
    assert (ROOT / "client" / "VERSION").read_text(encoding="utf-8").strip() == "1.3.25"
    ...
    assert catalog["releases"][0]["release_id"] == "clientflow-1.3.24-seq-1225"
