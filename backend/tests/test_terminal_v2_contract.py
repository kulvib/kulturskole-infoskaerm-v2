...
class TerminalV2ContractTests(unittest.TestCase):
    ...
    def test_terminal_schema_is_adopted_at_new_head(self) -> None:
        ...
        self.assertEqual(contract.rsplit('EXPECTED_HEAD_REVISION = ', 1)[1].splitlines()[0], '"20260829_54a_display_parity"')
        self.assertIn('REVIEWED_BASELINE_ADOPTION_HEAD = "20260829_54a_display_parity"', runner)
