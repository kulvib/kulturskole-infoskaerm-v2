...
def test_51f_promoted_1318_keeps_1311_safe_in_place_baseline_and_requires_reboot() -> None:
    catalog = json.loads(CATALOG_PATH.read_text(encoding="utf-8"))
    release = catalog["releases"][0]

    # 1.3.11/1212 remains the first release containing the corrected
    # activation/update transaction implementation. 1.3.18/1219 is now the
