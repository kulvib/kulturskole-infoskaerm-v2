...
export function buildFreshInstallDownloadCommand(created) {
  ...
  return [
    ...
    "",
    "  export BACKEND_URL ENROLLMENT_CODE FRESH_INSTALL_AUTHORIZATION RELEASE_ID APPROVED_BUNDLE_SHA256 APPROVED_BUNDLE_SIZE ARTIFACT_PATH BUNDLE",
    ...
    "printf '%s\\n' 'Paste the enrollment code and authorization only at the hidden prompts.'",
  ].join("\n");
}
